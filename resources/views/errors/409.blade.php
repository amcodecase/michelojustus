...
<body>
    <div class="error-container">
        ...
        <h1 class="error-title">Conflict Error</h1>
        <p class="error-message">
            There was a conflict with your request. The resource you're trying to modify 
            may have been changed by someone else. Please refresh and try again.
        </p>
